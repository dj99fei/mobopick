...
package com.cyou.mobopick.providers;
 ...
 * downloads. Clients may request that a URI be isDownloaded to a particular
...
public class DownloadManager {
    ...
    /**
     * URI to be isDownloaded.
     */
    public final static String COLUMN_URI = "uri";

    /**
     * Internet Media Type of the isDownloaded file. If no value is provided upon
    ...
    /**
     * Uri where isDownloaded file will be stored. If a destination is supplied by
    ...
    public final static String COLUMN_PACKAGE = "package";
    ...
    private static final String[] COLUMNS = new String[]{COLUMN_ID,
            ...
            COLUMN_LAST_MODIFIED_TIMESTAMP, COLUMN_PACKAGE};
    ...
    private static final String[] UNDERLYING_COLUMNS = new String[]{
            ...
            Downloads.COLUMN_FILE_NAME_HINT, Downloads._DATA,Downloads.COLUMN_USER_AGENT,};
    ...
    public static class Request {
        ...
        /**
         * Set the local destination for the isDownloaded file. Must be a file URI
        ...
        /**
         * Set the local destination for the isDownloaded file to a path within
        ...
        ContentValues toContentValues(String packageName) {
            ...
            putIfNonNull(values, Downloads.COLUMN_USER_AGENT, this.packageName);
     ...
     * through the download manager. If a file was already isDownloaded to
    ...
    /**
     * Open a isDownloaded file for reading. The download must have completed.
     *
    ...
    public static class CursorTranslator extends CursorWrapper {
        ...
        private String translateString(String column) {
            ...
            if (column.equals(COLUMN_PACKAGE)) {
                return getUnderlyingString(Downloads.COLUMN_USER_AGENT);
            }
